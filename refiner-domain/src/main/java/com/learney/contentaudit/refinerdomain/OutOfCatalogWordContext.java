...
public class OutOfCatalogWordContext {
    ...
    public OutOfCatalogWordContext() {
    }

    public OutOfCatalogWordContext(String lemma, String observedPos, Integer frequencyRank,
            double discount) {
        this.lemma = lemma;
    ...
    public boolean equals(Object o) {
        ...
        OutOfCatalogWordContext that = (OutOfCatalogWordContext) o;
