...
public class SentenceLengthContextResolver implements CorrectionContextResolver {
    ...
    @Override
    public Optional<SentenceLengthCorrectionContext> resolveWithIndex(AuditNodeIndex nodeIndex, AuditReport report, RefinementTask task) {
        if (report.getRoot() == null) {
            return Optional.empty();
        }
    ...
    public boolean supports(DiagnosisKind kind) {
        return kind == DiagnosisKind.SENTENCE_LENGTH;
    }
