...
public class KnowledgeInstructionsLengthAnalyzerSentinelTest {
   ...
   * Rule: Las instrucciones de cada knowledge se evaluan contra dos umbrales de longitud ponderada que separan tres rangos de puntuacion (R006): | Parametro | Valor | Significado | |-----------|-------|-------------| | Limite suave (soft limit) | 70 caracteres ponderados | Las instrucciones empiezan a ser largas | | Limite duro (hard limit) | 100 caracteres ponderados | Las instrucciones son definitivamente demasiado largas | La longitud se calcula usando el mismo sistema de pesos por caracter definido en R002 para titulos. Esto alinea el calculo con la implementacion de referencia, que usa longitud ponderada tanto para titulos como para instrucciones. Estos limites son observables a traves del comportamiento de puntuacion descrito en R006: una instruccion con longitud ponderada igual a 70 recibe 1.0, mayor a 70 y hasta 100 recibe 0.5, y mayor a 100 recibe 0.0. Los valores 70 y 100 no son configurables (ver "Decisiones de simplicidad" en Contexto).
   */
  @Test
