...
class LemmaRecurrenceAnalyzerIntegrationTest {
    ...
    void fullPipelineReturnsCorrectScore() {
        ...
        AuditableQuiz quiz1 = new AuditableQuiz(List.of(theToken, catToken), null, null, null, null, List.of("the cat"), null, null, null);
        AuditableQuiz quiz2 = new AuditableQuiz(List.of(theToken, catsToken), null, null, null, null, List.of("the cats"), null, null, null);
